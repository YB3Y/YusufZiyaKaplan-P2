...
namespace _231116032_Yusuf_Ziya_Kaplan_P2
{
    public partial class FrmYeniMüşteri : Form
    {
        ...
        {
            MessageBox.Show("Mavi Renkli Buttonlar Dolu Odaları Gösterir ");
        }

        private void BtnBosOda_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Yeşil Renkli Buttonlar Dolu Odaları Gösterir ");
        }
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            baglanti.Close();
            MessageBox.Show("Muşteri Kaydı Yapıldı");
        }
...
//Data Source=ZIYA\SQLEXPRESS;Initial Catalog="Aycicegi Pansiyon";Integrated Security=True;Trust Server Certificate=True
